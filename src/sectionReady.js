  ...
  return (
    <section className='relative container mx-auto py-24 rounded-[20px] bg-[#E8EDE7] overflow-hidden' >
      <div className='absolute bottom-[-50px] left-[-70px]'>
        <img src="/pattern-fork.svg" className='w-full h-full object-contain hidden md:block '  alt='pattern-fork' />
      </div>
      <div className='absolute top-[6px] right-[-60px]'>
        <img src="/pattern-knife.svg" className='w-full h-full object-contain hidden md:block' alt='pattern-knife' />
      </div>
